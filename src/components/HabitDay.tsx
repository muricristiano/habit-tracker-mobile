...
export function HabitDay({amountOfHabits = 0, amountCompleted = 0, date, ...rest}: Props){
    ...
    const amountAccomplishedPercentage = amountOfHabits > 0
    ? 
    ...
    return (
        <TouchableOpacity
            className={clsx("rounded-lg border-2 m-1", {
                ...
                ['bg-violet-900 border-violet-900'] : amountAccomplishedPercentage > 0 && amountAccomplishedPercentage < 20,
                ...
                ['bg-violet-500 border-violet-400'] : amountAccomplishedPercentage >= 80 && amountAccomplishedPercentage < 100,
                ['bg-violet-400 border-violet-100'] : amountAccomplishedPercentage >= 100,
